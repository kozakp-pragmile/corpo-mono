...
async function run() {
  ...
  step("1. Create standard notification type (EMAIL)");
  ...
  // ── 3. Patch name and senderName ───────────────────────────
  step("3. Patch name and senderName");
  ...
  console.log(`\n${"═".repeat(115)}`);
  console.log("  Done — standard notification type lifecycle complete");
