...
const TEMPLATES_DIR = resolve(__dirname, "..", "..", "..", "templates", "legacy-aggregation-thymeleaf");
...
const TAG = "pigeon-api-tests-legacy-aggregation-thymeleaf";
...
async function run() {
  ...
  if (!summary("legacy aggregation scenario — THYMELEAF wrappers (daily + weekly)")) {
    process.exitCode = 1;
  }
}
